...
void writeToPDF(int run_num){
  ...
  TPad *c_snap_2 = new TPad("c_snap_2", "Snapshots 2", 0, 0, 1, 1);
  ...
  snapshots_pad(infile, run_num, output_path, c_snap, true); //snapshots_1.png
  snapshots_pad_2(infile, run_num, output_path, c_snap_2, true); //snapshots_2.png
