...
def writeCFG(run_num):
  ...
  write_str = '\n\n'
  reg_plots = [('Essential Stats', 1), ('Essential Stats 2', 18), ('Snapshots', 2), ('Spectra', 3), ('Acc0', 4), \
               ('Acc0 vs Time', 5), ('Asym and Polarization', 11), ('Asyms vs Time', 12), \
               ('Acc4 Asym and Polarization', 13), ('Acc4 Asyms vs Time', 14), ('Beam OFF Asym', 15), \
               ('Detector Rates', 16), ('Detector Asyms', 17)]
