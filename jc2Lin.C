...
void jc2Lin(int run, int halfGain = 0, int nparams = 2, int firstIndex = 0, int lastIndex=150, double dark_delta = 404 /* 0.002612*/ , bool runPlot = true)
{
  if(runPlot) {
  ...
  if(dark_delta == 404) {
    dark_delta = MM::getDarkDelta(run);
  }
  //gROOT->ProcessLine(Form(".x fitPulser.C(%d,150-3,0.003161)",nparams));
