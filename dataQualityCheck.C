...
void quartet_plots(TChain* somethingwise, int run_num, TFile* outfile, int max_event){
  ...
  TString meas[18] = {posH0, negH0, diff0, summ0, asym0, posH4, negH4, diff4, summ4, asym4, asymUSbg1, asymUSbg2, asymDSbg1, asymDSbg2, asymHoriz, asymVert, "", ""};
  TString meas_id[18] = {"PosHelAcc0/NSamples0", "NegHelAcc0/NSamples0", "Diffs0", "Sums0", "Asyms0 (Raw)", "PosHelAcc4", "NegHelAcc4", "Diffs4", "Sums4", "Asyms4 (Raw)",
                         "Asyms USbg1", "Asyms USbg2", "Asyms DSbg1", "Asyms DSbg2", "Asyms Horiz Finger", "Asyms Vert Finger", "Asyms0", "Asyms4"};
  TString meas_small[18] = {"posH0", "negH0", "diff0", "summ0", "asym0", "posH4", "negH4", "diff4", "summ4", "asym4", 
                            "USbg1", "USbg2", "DSbg1", "DSbg2", "horizFing", "vertFing", "asym0subAvg",  "asym4subAvg"};
  ...
  for(int i = 0; i < 18; i++){
    if(i==16){
      meas[i]   = Form("1000*(%s)/(%f - %f)", diff0.Data(), summOn0, summOff0);
      meas[i+1] = Form("1000*(%s)/(%f - %f)", diff4.Data(), summOn4, summOff4);
    }
...
void quartet_graphs(TChain* somethingwise, int run_num, TFile* outfile, TString tree_id, int max_event){
  ...
  Int_t n_msmts = 18;
  TString msmts[18] = {"posH0", "negH0", "diff0", "summ0", "asym0", "bcm", "posH4", "negH4", "diff4", "summ4", "asym4",
                       "USbg1", "USbg2", "DSbg1", "DSbg2", "vertFing", "horizFing", "cavPow"};
  ...
  Double_t ymins[18] = { 1e16,  1e16,  1e16,  1e16,  1e16,  1e16,  1e16,  1e16,  1e16,  1e16,  1e16,
                         1e16,  1e16,  1e16,  1e16,  1e16,  1e16,  1e16};
  Double_t ymaxs[18] = {-1e16, -1e16, -1e16, -1e16, -1e16, -1e16, -1e16, -1e16, -1e16, -1e16, -1e16,
                        -1e16, -1e16, -1e16, -1e16, -1e16, -1e16, -1e16};
  for(int i = 0; i < somethingwise->GetEntries(); i++){
    somethingwise->GetEntry(i);
    ...
    Double_t msmt[18] = {posAcc/posSamp, negAcc/negSamp, posAcc/posSamp - negAcc/negSamp, posAcc/posSamp + negAcc/negSamp, 
                        1000*(posAcc/posSamp - negAcc/negSamp)/(posAcc/posSamp + negAcc/negSamp), (posBCM + negBCM)/2.0, 
                         posAcc4/posSamp4, negAcc4/negSamp4, posAcc4/posSamp4 - negAcc4/negSamp4, posAcc4/posSamp4 + negAcc4/negSamp4,
                        1000*(posAcc4/posSamp4 - negAcc4/negSamp4)/(posAcc4/posSamp4 + negAcc4/negSamp4),
  ...
  TString nameOn0 = Form("%s_beam1_las1_asym0subAvg_time", tree_id.Data());
  ...
  TString nameOff0 = Form("%s_beam1_las0_asym0subAvg_time", tree_id.Data());
  ...
  TString nameOn4 = Form("%s_beam1_las1_asym4subAvg_time", tree_id.Data());
  ...
  TString nameOff4 = Form("%s_beam1_las0_asym4subAvg_time", tree_id.Data());
